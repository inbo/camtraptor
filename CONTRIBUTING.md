...
First of all, thanks for considering contributing to camtraptor! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on camtraptor. 😊

camtraptor is an open source project, maintained by people who care. We
...
Think camtraptor is useful? Let others discover it, by telling them in
person, via Twitter or a blog post.

Using camtraptor for a paper you are writing? Consider [citing
it](https://inbo.github.io/camtraptor/authors.html). Still, this package
is more a test environment to contribute and improve existent packages,
such as [camtrapR](https://jniedballa.github.io/camtrapR/).

### Ask a question ⁉️

Using camtraptor and got stuck? Browse the
[documentation](https://inbo.github.io/camtraptor) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/inbo/camtraptor/issues/new). While we cannot
...
Have an idea for a new camtraptor feature? Take a look at the
[documentation](https://inbo.github.io/camtraptor) and [issue
list](https://github.com/inbo/camtraptor/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/inbo/camtraptor/issues/new). While we can’t
...
Using camtraptor and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/inbo/camtraptor/issues/new) so we can fix it.
...
issue](https://github.com/inbo/camtraptor/issues/new) and we can point
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/inbo/camtraptor).
...
Care to fix bugs or implement new functionality for camtraptor? Awesome!
👏 Have a look at the [issue
list](https://github.com/inbo/camtraptor/issues) and leave a comment on
...
1.  Fork [this repo](https://github.com/inbo/camtraptor) and clone it to
