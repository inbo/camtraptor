...
#' calibration models.
#'
#' @param animal_pos Dataframe of animal position digitisation data.
...
#'
#' @examples
#' predict_pos(animal_positions, dep_calib_models)
predict_pos <- function(animal_pos, calib_models,
                        dep_tag = "deployment",
                        x = "x", y = "y",
