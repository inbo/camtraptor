...
read_wi <- function(directory = ".",
  ...
  wi_projects$ark_id = stringr::str_extract(
    wi_projects$data_citation,
  ...
  package$licenses <- list(
    list(
      name = wi_projects$metadata_license,
      scope = "data"
      ),
    list(
  ...
  package$organizations <- list(list(title = wi_projects$project_admin_organization))
  package$rightsHolder <- ifelse(rightsHolder == "project_admin_organization",
    wi_projects$project_admin_organization, rightsHolder
  )
  package$bibliographicCitation <-stringr::str_replace_all(wi_projects$data_citation, "[\r\n]", "")
  package$project <- list(
    id = toString(wi_projects$project_id),
    ...
    samplingDesign =  dplyr::case_when(
      wi_projects$project_sensor_layout == "Systematic" ~ "systematic random",
      wi_projects$project_sensor_layout == "Randomized" ~ "simple random",
      wi_projects$project_sensor_layout == "Convinience" ~ "opportunistic",
      wi_projects$project_sensor_layout == "Targeted" ~ "targeted",
    ),
