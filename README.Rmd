...
- [camtrapR](https://cran.r-project.org/package=camtrapR) is an analysis R package for camera trap data. camtraptor initially offered a number of functions to transform Camtrap DPs to outputs compatible with camtrapR. These have been deprecated, because camtrapR now supports reading Camtrap DPs.
...
- We welcome [contributions](https://inbo.github.io/camtraptor/CONTRIBUTING.html) including bug reports.
- License: MIT
- Get citation information for camtraptor in R with `citation("camtraptor")`.
- Please note that this project is released with a [Contributor Code of Conduct](https://inbo.github.io/camtraptor/CODE_OF_CONDUCT.html). By participating in this project you agree to abide by its terms.
