...
- [camtrapR](https://cran.r-project.org/package=camtrapR) is an analysis R package for camera trap data. camtraptor offers a number of `camtrapR_` functions to transform Camtrap DPs to outputs compatible with camtrapR.
