...
test_that("check effort and unit values", {
  ...
  filter_deploys <- suppressMessages(
    get_custom_effort(
      filter_deployments(x, latitude >= 51),
      group_by = "year"
    )
  )
