...
This vignette shows how to get a **camera operation matrix** from a Camera Trap Data Package dataset, equivalent to the matrix returned by camtrapR's function [camtrapR::cameraOperation](https://jniedballa.github.io/camtrapR/reference/cameraOperation.html). Notice that this functionality has been deprecated in camtraptor version 1.0 as camtrapR supports Camera Trap Data Packages, see the function [camtrapR::readCamtrapDP()].
