...
You can customize the icon shown for zero-value deployments by passing an icon URL to `zero_values_icon_url` and its size in pixels to `zero_values_icon_size`. Many free icon libraries are available online, such as [icons8](https://icons8.com/). The following example uses a custom icon with a size of 50 pixels:
