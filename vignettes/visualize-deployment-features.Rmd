...
It can happen that some deployments didn't observe any animal. While visualizing the number of species, they are shown in the map as multiplication symbols `×` as deployments with zero values and a message is returned to the R console:
