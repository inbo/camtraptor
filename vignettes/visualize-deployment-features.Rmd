...
Common names are allowed as well:
...
Argument `species` is also case insensitive:
...
Upper limit lower than number of detected species:
...
Upper limit higher than number of detected species:
