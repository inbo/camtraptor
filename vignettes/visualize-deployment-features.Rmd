...
This vignette shows how to use function `map_dep()` to visualize on a leaflet map two important deployment features: 
...
As some featues must or could be used in combination with a species name, it's sometimes useful to have an idea first about which species have been detected:
...
testthat::expect_error(
  ...
  paste0("Invalid value for species argument.\n",
         ...
         "Ondatra zibethicus, Myocastor coypus and Gallinula chloropus."
        )
)
```
