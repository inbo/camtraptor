...
testthat::expect_error(
  ...
  paste0("Invalid value for species argument.\n",
         "Valid inputs are: anas platyrhynchos, gallinula chloropus, ",
         "myocastor coypus, ondatra zibethicus, rattus norvegicus, ", 
         "mallard, common moorhen, coypu, muskrat, brown rat, ",
         "wilde eend, waterhoen, beverrat, muskusrat and bruine rat.")
)
```
...
You maybe would like to visualize deployment information for a subset of deployments. To do this, you can use filter predicates. E.g. visualize number of observations for the deployments with longitude equal or higher than 3.6:

```{r example_filter_predicates_map}
map_dep(camtrapdp,
        pred_gt("longitude", 3.6),
        feature = "n_obs")
```
