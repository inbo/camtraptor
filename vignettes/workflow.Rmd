...
> **Note:** Coming from `camtraptor` version 0.28 or earlier? Check out [News](https://inbo.github.io/camtraptor/news/index.html) to see what changed. Deprecated functions will throw a warning pointing you towards their replacements.
...
> **Note**: For more information about visualization, check out the next vignette `vignette("visualize-deployment-features")`.
