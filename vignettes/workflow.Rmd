...
Camtraptor is an R package to **read**, **explore**, **filter**, **summarize** and  **visualize** [Camera Trap Data Package](https://camtrap-dp.tdwg.org/) (Camtrap DP) datasets. This vignette walks you through the intended workflow of the package.

> **Note:** Coming from `camtraptor` version 0.xx? Check out `NEWS.md` to see what changed. Deprecated functions will throw a warning pointing you towards their replacements.
