...
```
As you can see, there is only one of the two deployments we filtered for observed mallard.


Visualize the daily effort per deployment:
...
```
  ...
  > **For more information about visualization, checkout [the next vignette about visualizing](visualize-deployments-features.html)**