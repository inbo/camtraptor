---
title: "Intended workflow of the package"
author: "Wolf Missotten"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Intended workflow of the package}
...
Camtraptor is an R package to **read**, **explore** and  **visualize** [Camera Trap Data Package](https://camtrap-dp.tdwg.org/) (Camtrap DP) datasets. This vignette walks you through the intended workflow of the package.
...
You can also filter using `filter_media()`, but this wil not be discussed in this vignette.
